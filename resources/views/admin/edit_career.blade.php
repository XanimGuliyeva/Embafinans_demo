@extends('admin.index')
@section('admin')
    <input hidden id="city" name="{{$career->city}}">
    <input hidden id="deadline" name="{{$career->deadline}}">
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <input class="form-control" name='header'  type='text' placeholder="Başlıq" value="{{$career->header}}"><br>
                        ...
                        <textarea name="text" id="myTextarea" class="tinymce">{!! $career->content !!}</textarea>
                        <br>
                        <input name=image type=file id="upload" hidden onchange=""><br>
                        <button type="button" class="edit_career btn btn-lg btn-dark offset-5" id="{{$career->id}}">Dəyiş</button>
                    </div>
                </div>
            </div>
        </div>
