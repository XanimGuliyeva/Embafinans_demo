                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="edit_partner">
                            @csrf
                            <input class="form-control" name=name type=text placeholder="Şirkətin adı" value="{{$partner->name}}"><br>
                            <select style="color: #525f7f;" name="city" class="form-control" id="{{$partner->city}}">
                            ...
                            <input class="form-control" name=address type=text placeholder="Ünvan" value="{{$partner->address}}"><br>
                            <select style="color: #525f7f;" name="category" class="form-control" id="{{$partner->category}}">
                            ...
                            <input class="form-control" name=phone type=text placeholder="Telefon nömrəsi" value="{{$partner->phone}}"><br>
                            <textarea class="form-control" name=about type=text placeholder="Qısa məzmun">{{$partner->about}}</textarea><br>
                            <input class="form-control" name=contact_person type=text placeholder="Əlaqə saxlanılacaq şəxs" value="{{$partner->contact_person}}"><br>
                            <input class="form-control" name=email type=text placeholder="E-poçt ünvanı" value="{{$partner->email}}"><br>
                            <input class="form-control" name=website type=text placeholder="Veb sayt" value="{{$partner->website}}"><br>
                            <input class="form-control" name=director type=text placeholder="Direktorun adı, soyadı, atasının adı" value="{{$partner->director}}"><br>
                            <input class="form-control" name=contact_phone type=text placeholder="Əlaqə saxlanılacaq şəxsin telefon nömrəsi" value="{{$partner->contact_phone}}"><br>
                            <label>Şirkət logosu</label><br>
                            <img width="80" height="80" id="partner_image" src="{{asset('images/'.$partner->image)}}"><br>
                            <input class="form-control" name=image type=file><br>
                            <textarea name="text" id="myTextarea" class="tinymce">{!! $partner->content !!}</textarea>
                            <br>
                            <input name=image type=file id="upload" hidden onchange=""><br>
                        </form>
                        <button type="button" class="edit_partner btn btn-lg btn-dark offset-5" name="{{$partner->id}}">Yerləşdir</button>
                    </div>
                </div>
            </div>
        </div>
