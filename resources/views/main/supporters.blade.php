...
@section('main')
    ...
    <div class="content-center">
        <div class="main-content">
            <span class="main-caption">Tərəfdaşlıq müraciəti</span>
            <div class="applies">
                <form id="add_apply" class="partner-back col-lg-10 supporter_add">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6 partner-left">
                            ...
                            <select name="category" class="partnership-register">
                                <option value="category" selected >Kateqoriya *</option>
                            ...
                            <textarea name="about"  style="resize: none;" placeholder="Qısa məlumat"></textarea>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div style="text-align:center;width:75%;margin-top:30px">
                                <a href="#" class="send partner-send add_supporter">Tərəfdaş ol</a>
                            </div>
                        </div>
                    </div>
                </form>
